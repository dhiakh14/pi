...
export declare class _WebAudioStaticSound extends StaticSound implements IWebAudioSuperNode {
    ...
    /** @internal */
    init(source: StaticSoundSourceType, options: Partial<IStaticSoundOptions>): Promise<void>;
    /** @internal */
...
export declare class _WebAudioStaticSoundBuffer extends StaticSoundBuffer {
    ...
    init(source: StaticSoundSourceType, options: Partial<IStaticSoundBufferOptions>): Promise<void>;
    /** @internal */
